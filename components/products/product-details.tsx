        ...
        <div className="bg-white rounded-lg px-6 py-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col gap-2 w-20">
                {product?.images.map((image, index) => (
                  <button
                    ...
                    className={`relative w-20 h-20 border rounded-lg overflow-hidden ${currentImageIndex === index
              ...
              <div className="relative flex flex-1 ">
                ...
                <div className="relative aspect-square w-full border bg-white rounded-lg overflow-hidden">
                  ...
                  />
                    ...
                    <Image
                    src={normalizeImageUrl(product?.images[currentImageIndex].url)}
            ...
            <div className="space-y-6 flex flex-col justify-between">
              ...
              <p className="text-gray-600">
                A farinha de linhaça marrom da Vitao é moída de forma fina, o que a torna fácil de
                incorporar em diversas receitas, como pães, bolos, panquecas, smoothies e barras de cereais.
              </p>
