    ...
    <DialogContent className="max-w-lg max-h-[90vh] min-h-[60vh] overflow-y-auto">
      <DialogHeader>
        ...
        <p className="text-sm text-gray-600 mt-1">
          {format(new Date(data.orderDate), "dd 'de' MMMM 'de' yyyy 'às' HH:mm", { locale: ptBR })}
        </p>
      </DialogHeader>
      ...
      <div className="space-y-4">
            ...
            <div key={item.id} className="flex items-start justify-between py-2">
              <div className="flex items-start gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-gray-600">Código: {item.productExternalCode}</p>
                </div>
              </div>
        ...
        <div className="flex gap-4 justify-between">
          ...
          <div>
            ...
            <p className="text-sm">{formatCurrencyBRL(data.discountValue)}</p>
          </div>
          <div>
        ...
        {data.orderInvoice && (
          <div className="flex justify-between items-center">
            <div>
              ...
              <code className="flex-1 text-sm break-all">{data.orderInvoice}</code>
            </div>
